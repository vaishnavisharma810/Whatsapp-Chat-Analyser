...
if uploaded_file is not None:
    bytes_data = uploaded_file.getvalue()  #file will be now a stream of byte data we have to convert it to string
    ...
    if st.sidebar.button("Show Analysis"):  #if someone will click this button, then analysis will start
